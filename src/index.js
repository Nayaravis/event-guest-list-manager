...
function showGuests() {
    if (guests.length === 0) {
        ...
        guests.forEach(guest => {
            ...
            let divider = document.createElement("hr") // the divider for the items
            ...
            <div class='flex gap-2'>
                <button class="p-2 rounded-lg" onClick='updateRSVP(${guest.id}, "yes")'>
                ...
                <button class="p-2 rounded-lg" onClick='updateRSVP(${guest.id}, "no")'>
                ...
                <button class="p-2 rounded-lg" onClick='updateRSVP(${guest.id}, null)'>
                ...
                <button class="p-2 rounded-lg" onClick='deleteGuest(${guest.id})'>
